...
var _Natim$twitter_elm_wall$Utils$plural = F2(
...
var _Natim$twitter_elm_wall$Utils$timeAgo = F2(
	function (time, now) {
		...
		return (_elm_lang$core$Native_Utils.cmp(seconds, 10) < 0) ? 'a few seconds ago' : ((_elm_lang$core$Native_Utils.cmp(seconds, 55) < 0) ? A2(_Natim$twitter_elm_wall$Utils$plural, 'second', seconds) : (A3(_Natim$twitter_elm_wall$Utils$within, 55, 65, seconds) ? 'about a minute ago' : ((_elm_lang$core$Native_Utils.cmp(minutes, 55) < 0) ? A2(_Natim$twitter_elm_wall$Utils$plural, 'minute', minutes) : (A3(_Natim$twitter_elm_wall$Utils$within, 55, 65, minutes) ? 'about an hour ago' : ((_elm_lang$core$Native_Utils.cmp(hours, 22) < 0) ? A2(_Natim$twitter_elm_wall$Utils$plural, 'hour', hours) : (A3(_Natim$twitter_elm_wall$Utils$within, 22, 26, hours) ? 'about a day ago' : (A3(_Natim$twitter_elm_wall$Utils$within, 6, 8, days) ? 'about a week ago' : (A3(_Natim$twitter_elm_wall$Utils$within, 14, 16, days) ? 'about 2 weeks ago' : (A3(_Natim$twitter_elm_wall$Utils$within, 20, 22, days) ? 'about 3 weeks ago' : ((_elm_lang$core$Native_Utils.cmp(days, 27) < 0) ? A2(_Natim$twitter_elm_wall$Utils$plural, 'day', days) : (A3(_Natim$twitter_elm_wall$Utils$within, 27, 33, days) ? 'about a month ago' : ((_elm_lang$core$Native_Utils.cmp(months, 11) < 0) ? A2(_Natim$twitter_elm_wall$Utils$plural, 'month', months) : (A3(_Natim$twitter_elm_wall$Utils$within, 11, 13, months) ? 'about a year ago' : A2(_Natim$twitter_elm_wall$Utils$plural, 'year', years))))))))))))));
	});
...
var _Natim$twitter_elm_wall$App$normalizeDate = A2(
	_elm_lang$core$Json_Decode$map,
	function (d) {
		return A2(
			_elm_lang$core$Result$withDefault,
			_elm_lang$core$Date$fromTime(0),
			_elm_lang$core$Date$fromString(d));
	},
	_elm_lang$core$Json_Decode$string);
var _Natim$twitter_elm_wall$App$getDate = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['created_at']),
	_Natim$twitter_elm_wall$App$normalizeDate);
var _Natim$twitter_elm_wall$App$getText = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['text']),
	_elm_lang$core$Json_Decode$string);
var _Natim$twitter_elm_wall$App$getAuthor = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['user', 'name']),
	_elm_lang$core$Json_Decode$string);
var _Natim$twitter_elm_wall$App$displayTweet = F2(
	function (currentTime, tweet) {
		var author = A2(_elm_lang$core$Basics_ops['++'], 'Author: ', tweet.author);
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html$text(
					A2(
						_Natim$twitter_elm_wall$Utils$timeAgo,
						_elm_lang$core$Date$toTime(tweet.date),
						currentTime))
				]));
	});
var _Natim$twitter_elm_wall$App$twitterApiUrl = 'https://cors-anywhere.herokuapp.com/https://api.twitter.com/1.1/search/tweets.json?q=';
var _Natim$twitter_elm_wall$App$twitterBearerToken = 'AAAAAAAAAAAAAAAAAAAAAJc9xAAAAAAAEqIw9D7P%2FVH3tw3WZyFcIyhmUv4%3D5eWCMgEwC4YSfnMzkH7PZ0HeN4ql6i0hfZQ9EZ6KYXPsoXqGPy';
var _Natim$twitter_elm_wall$App$Tweet = F3(
	function (a, b, c) {
		return {author: a, text: b, date: c};
	});
var _Natim$twitter_elm_wall$App$getTweet = A4(_elm_lang$core$Json_Decode$object3, _Natim$twitter_elm_wall$App$Tweet, _Natim$twitter_elm_wall$App$getAuthor, _Natim$twitter_elm_wall$App$getText, _Natim$twitter_elm_wall$App$getDate);
var _Natim$twitter_elm_wall$App$decodeTweet = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['statuses']),
	_elm_lang$core$Json_Decode$list(_Natim$twitter_elm_wall$App$getTweet));
var _Natim$twitter_elm_wall$App$Model = F4(
	function (a, b, c, d) {
		return {tweets: a, error: b, currentTime: c, currentSearch: d};
	});
var _Natim$twitter_elm_wall$App$NewSearch = function (a) {
	return {ctor: 'NewSearch', _0: a};
};
var _Natim$twitter_elm_wall$App$Refresh = function (a) {
	return {ctor: 'Refresh', _0: a};
};
var _Natim$twitter_elm_wall$App$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Tweet Elm Wall')
					])),
				_elm_lang$html$Html$text(
				...
				A2(
					_elm_lang$core$List$map,
					_Natim$twitter_elm_wall$App$displayTweet(model.currentTime),
					model.tweets)),
				A2(
				_elm_lang$html$Html$input,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onInput(_Natim$twitter_elm_wall$App$NewSearch),
						_elm_lang$html$Html_Attributes$value(model.currentSearch)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_Natim$twitter_elm_wall$App$Refresh(model.currentTime))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _Natim$twitter_elm_wall$App$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _Natim$twitter_elm_wall$App$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _Natim$twitter_elm_wall$App$Tick),
				A2(_elm_lang$core$Time$every, _elm_lang$core$Time$hour, _Natim$twitter_elm_wall$App$Refresh)
			]));
};
var _Natim$twitter_elm_wall$App$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _Natim$twitter_elm_wall$App$FetchSucceed = function (a) {
	return {ctor: 'FetchSucceed', _0: a};
};
var _Natim$twitter_elm_wall$App$getTweets = function (query) {
	return A3(
		_elm_lang$core$Task$perform,
		_Natim$twitter_elm_wall$App$FetchFail,
		_Natim$twitter_elm_wall$App$FetchSucceed,
		A3(
			_lukewestby$elm_http_builder$HttpBuilder$send,
			_lukewestby$elm_http_builder$HttpBuilder$jsonReader(_Natim$twitter_elm_wall$App$decodeTweet),
			_lukewestby$elm_http_builder$HttpBuilder$stringReader,
			A3(
				_lukewestby$elm_http_builder$HttpBuilder$withHeader,
				'Authorization',
				A2(_elm_lang$core$Basics_ops['++'], 'Bearer ', _Natim$twitter_elm_wall$App$twitterBearerToken),
				_lukewestby$elm_http_builder$HttpBuilder$get(
					A2(
						_elm_lang$core$Basics_ops['++'],
						_Natim$twitter_elm_wall$App$twitterApiUrl,
						_evancz$elm_http$Http$uriEncode(query))))));
};
var _Natim$twitter_elm_wall$App$init = {
	ctor: '_Tuple2',
	_0: {
	...
	_1: _Natim$twitter_elm_wall$App$getTweets('#elm')
};
var _Natim$twitter_elm_wall$App$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Tick':
			...
			case 'Refresh':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _Natim$twitter_elm_wall$App$getTweets(model.currentSearch)
				};
			case 'NewSearch':
				return {
					ctor: '_Tuple2',
...
var _Natim$twitter_elm_wall$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _Natim$twitter_elm_wall$App$init, view: _Natim$twitter_elm_wall$App$view, update: _Natim$twitter_elm_wall$App$update, subscriptions: _Natim$twitter_elm_wall$App$subscriptions})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _Natim$twitter_elm_wall$Main$main === 'undefined' ? null : _Natim$twitter_elm_wall$Main$main);
