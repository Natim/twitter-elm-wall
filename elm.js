...
var _user$project$Main$getTitle = A2(
...
var _user$project$Main$attachmentUrl = 'https://kinto-ota.dev.mozaws.net/attachments/';
var _user$project$Main$displayImage = function (image) {
	var fullUrl = A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$attachmentUrl, image.url);
	var author = A2(_elm_lang$core$Basics_ops['++'], 'Author: ', image.title);
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$src(fullUrl),
						_elm_lang$html$Html_Attributes$title(author)
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, _user$project$Main$displayImage, model.images))
			]));
};
var _user$project$Main$stripAbsolute = function (str) {
	return A2(_elm_lang$core$String$startsWith, _user$project$Main$attachmentUrl, str) ? A2(
		_elm_lang$core$String$dropLeft,
		_elm_lang$core$String$length(_user$project$Main$attachmentUrl),
		str) : str;
};
var _user$project$Main$normalizeUrl = A2(_elm_lang$core$Json_Decode$map, _user$project$Main$stripAbsolute, _elm_lang$core$Json_Decode$string);
var _user$project$Main$getLocation = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['attachment', 'location']),
	_user$project$Main$normalizeUrl);
var _user$project$Main$kintoUrl = 'https://kinto-ota.dev.mozaws.net/v1/buckets/dadounets/collections/wall/records?attachment.mimetype=image/jpeg';
var _user$project$Main$Image = F2(
	function (a, b) {
		return {title: a, url: b};
	});
var _user$project$Main$getImage = A3(_elm_lang$core$Json_Decode$object2, _user$project$Main$Image, _user$project$Main$getTitle, _user$project$Main$getLocation);
var _user$project$Main$decodeImageUrl = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['data']),
	_elm_lang$core$Json_Decode$list(_user$project$Main$getImage));
var _user$project$Main$Model = F2(
	function (a, b) {
		return {images: a, error: b};
	});
...
var _user$project$Main$getImages = A3(
	_elm_lang$core$Task$perform,
	_user$project$Main$FetchFail,
	_user$project$Main$FetchSucceed,
	A2(_evancz$elm_http$Http$get, _user$project$Main$decodeImageUrl, _user$project$Main$kintoUrl));
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {
		images: _elm_lang$core$Native_List.fromArray(
			[]),
		error: _elm_lang$core$Maybe$Nothing
	},
	_1: _user$project$Main$getImages
};
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Main$init, view: _user$project$Main$view, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions})
};
var _user$project$Main$Foo = {ctor: 'Foo'};
